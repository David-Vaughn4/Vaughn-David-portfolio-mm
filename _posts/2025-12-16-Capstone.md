...
![Carpentopod](/assets/images/Capstone/carpentopod.jpg)
...
So far, I have gone through about 3 full iterations of legs. The first was   and so the connectors (which replaced the nuts and bolts on the joints with the wooden models) wouldn't print correctly. After scaling everything up 200%, the second iteration still had the connectors too small and so in trying to put together the joints, they were too fragile and broke somewhat easily. This is that model:

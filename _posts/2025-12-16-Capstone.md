...
## Second Semester Journal/Decisions/Issues
### 1/8-1/22
...
Finally, I got both sides' motors hooked up to the PCB, worked with ChatGPT some more on the code, and printed some rectangular pieces to connect the sides on the top of the Johns through the helpful holes, with this as the result:

<video controls width="800" height="400" src="../assets/images/Capstone/23final walking.MOV">Download the video: <a href="../assets/images/Capstone/23final walking.MOV">final.mov</a></video>

<video controls width="800" height="400" src="../assets/images/Capstone/walking final2.MOV">Download the video: <a href="../assets/images/Capstone/walking final2.MOV">final2.mov</a></video>
...
Next, I plan to reprint the first side so that it can all be white and both sides will have common pieces and a common motor so that it will move more symmetrically and uniformly. I also shortly want to add a tabletop to it so that it acts functionally like a table. Once these two essential things are done, I want to program it to be able to turn accurately and efficiently. After that, I hope to make a more contained housing for the electronics. Finally, I hope to make many more of them of varying sizes and possibly incorporate some AI camera technology for smart tracking and personalization.

## Summary
So far this year, I've learned a lot about efficiently iterating, pushing through difficulties, and general good 3D CAD principles. Since this project involves so many moving mechanical pieces, working with that proved to be the the largest and most time-consuming issue by far, especially because any minor error in any part of a design meant redesigning and reprinting, often of multiple pieces. 

I have taken on large projects before, but this one over the last two years has been uniquely tedious in that sense majorly. Luckily, I generally enjoy the process of systemically analyzing problems, visualizing solutions, attempting to manifest those solutions, viewing the tangible outcome, and repeating the process, and for the rest of the aspects (electronics, etc.), I enjoy those as well because they came fairly easily in this case. I believe updated technology (newer and faster printers that fail less, AI to help coding) also played a major role in helping make this process more enjoyable and satisfying, allowing me to focus more solely on the creative side of engineering and less on the frustrating tedium.

About myself, I believe that I have learned that I enjoy the process of engineering more than I give myself credit for, and that despite the project taking so much longer than it seems like it should, I feel that process comes fairly naturally to me.

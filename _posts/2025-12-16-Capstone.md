...
#### Electronics
I first got an ESP32C6 to blink an LED on a breadboard, then connected it to this joystick and had it serial print values.

<video controls width="800" height="400" src="../assets/images/Capstone/joystick values.mov">Download the video: <a href="../assets/images/Capstone/joystick values.mov">white.mov</a></video>

...
## Milling
After exporting the toolpaths from Aspire to one file and uploading it to the Fab Lab google drive, I downloaded it on the milling machine's computer and opened it in CarveraController by selecting "Open g-code file", then selecting my file, then "select and export". I then opened the manual controller in the top right corner and selected 'home'. Finally, I selected 'run g-code file', used the configuration settings below, and it ran.

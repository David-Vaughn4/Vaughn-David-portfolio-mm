...
## 3D Printed Version
First, I 3D printed it. This is the Bambu file for the 3D print.

<img width="400" height="220" alt="Screenshot 2026-01-05 184335" src="https://github.com/user-attachments/assets/4931131a-cd7e-4fad-83f0-a66562f3ebc3" />
...
Finally, I used the bandsaw to trim away the excess sides:

![final](../assets/images/Topo_map/final_sawed.jpg)


## Workflow
[This is the workflow made by Dr. Taylor that I used to prepare the files in Aspire](https://github.com/user-attachments/files/24220621/workflow.pdf). 

You can also view it here:

<iframe src="https://docs.google.com/document/d/e/2PACX-1vQnOkdpb1ngcAKvWlhT2YUV8tZO9krHFhG_1UYvyiql_UDuq1UN-ZzaDvX-hsISE3OUW7lSq0gt-7Wg/pub?embedded=true" width="1800" height="1200" style="width:100%;max-width:1800px;height:1200px;border:0;"></iframe>

It is very thorough and so I never really deviated from it. The sole way I didn't directly follow it was that, in naming the toolpaths, I included my name for organization. 
